...
//             [title || task.rows[0].title, description || task.rows[0].description, due_date || task.rows[0].due_date, priority || task.rows[0].priority, status || task.rows[0].status, taskId]
//         );
